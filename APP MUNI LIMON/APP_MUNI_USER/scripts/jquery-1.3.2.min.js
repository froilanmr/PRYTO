 ...
 */
(function () {
    var l = this, g, y = l.jQuery, p = l.$, o = l.jQuery = l.$ =
        function (E, F) {
    ...
    o.fn = o.prototype = {
        ...
        map:
            function (E) {
                return this.pushStack(o.map(this, function (G, F) { return E.call(G, F, G) }))
            },
        andSelf:
            function () {
