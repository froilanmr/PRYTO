...
<body>
    <form id="form1" runat="server">
       ...
       <ul class="topnav2">
        ...
        <div id="dvGrid" style="width:auto; padding-left: 300px; padding-top:50px" class="auto-style2">
                    ...
                    <table border="1" style="border-collapse: collapse;">
                        ...
                        <tr>
                            <td style="padding: 20px" class="auto-style4">
                                ...
                                <asp:FileUpload ID="fileGaleria" runat="server" AllowMultiple="True" accept=".png,.jpg,.jpeg,.gif"></asp:FileUpload>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 20px" class="auto-style4">&nbsp;&nbsp;&nbsp;
