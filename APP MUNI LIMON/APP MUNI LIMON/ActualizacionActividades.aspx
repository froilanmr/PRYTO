<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActualizacionActividades.aspx.cs" Inherits="ActualizacionActividades" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Actualizacion de Actividades</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <fieldset>
           <h2 class="fs-title">Actualización de Actividades</h2>
            <asp:DropDownList ID="actividades" runat="server" CssClass="mydropdownlist">
               <asp:ListItem>--Seleccione la actividad a Actualizar--</asp:ListItem>
           ...
           <br />
           <asp:Button ID="registrarActividad" runat="server" Text="Registrar" class="next action-button" width="300px"/>
       </fieldset>
    </form>
</body>
</html>
