...
public partial class Perfil : System.Web.UI.Page
{
    ...
    protected void CargaDatos()
    {
        ...
        conx.Open();
        var cmd = new NpgsqlCommand("SELECT * FROM usuarioADMI where correo='" + usuario+ "' and contrasenna='"+ contra+"'" , conx);
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            string query = "UPDATE usuarioADMI set isBorrado=1 WHERE nombre=@nombre";
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        if (!Nombre.Equals("") || !Correo.Equals("") || !Contraseña.Equals("") || !Telefono.Equals(""))
        {
            try
            {
                string query = "UPDATE usuarioADMI SET nombre=@Nombre, correo=@Correo, contrasenna=@Contraseña," +
